...
from application.views import accueil, comptes, edaia, associationMedecinPatient, evaluation_symptomes, form_general_view ,caldio_view, prise_Medoc_view
...
urlpatterns = [
    ...
    path('prise_medoc/', prise_Medoc_view, name='prise_medoc'),
